# Generated by Django 4.1.2 on 2023-06-13 13:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Permissions for the employee', related_name='employee_user_permissions', related_query_name='employee', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demand_status', models.CharField(default='En vérification', max_length=50, verbose_name='Statut de la demande')),
